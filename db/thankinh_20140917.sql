...
--
-- Host: localhost
-- Generation Time: Sep 17, 2014 at 03:10 PM
...
--
-- Table structure for table `ntk_adv`
--

CREATE TABLE IF NOT EXISTS `ntk_adv` (
  `adv_id` int(11) NOT NULL AUTO_INCREMENT,
  `adv_name` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `adv_link` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `adv_image` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `ntk_adv`
--

INSERT INTO `ntk_adv` (`adv_id`, `adv_name`, `adv_link`, `adv_image`, `status`, `order`) VALUES
(2, 'panadol', 'http://www.panadol.com', 'panadol.jpg', 1, 3),
(3, 'Cefalexin', 'http://www.thuocbietduoc.com.vn/thuoc/thuoc-goc598.aspx', 'cafelexin.jpg', 1, 2);
