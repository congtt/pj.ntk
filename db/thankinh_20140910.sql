...
--
-- Host: localhost
-- Generation Time: Sep 10, 2014 at 06:53 PM
...
CREATE TABLE IF NOT EXISTS `ntk_hospital` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `provine_id` int(11) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `order` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `ntk_hospital` (`id`, `name`, `provine_id`, `status`, `order`) VALUES
(1, 'BV Chợ rẫy', 1, 1, 1),
...
(1, 'congtran90@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Trần Tấn Công', 1, 1, 1),
