...
require_once('include/db/DBManager.php');
...
class DBManagerFactory
{
        ...
        )
    {
        ...
        if( is_file("include/db/{$class_name}.php") && !class_exists($class_name))
            require_once("include/db/{$class_name}.php");
